    ...
    return(
        <div className = "about">
            ...
            <div className = "project">
                <p>
                    FricFracChat is a project that created collaboratively as a final project
                </p>
                ...
                <div className="techs">
                    ...
                    <div className= "githubRepo">
                        ...
                        <div className = "btn-repo">
                            <a href="https://github.com/Frictionless-Faction" target="_blank" rel="noreferrer">Github Reposityry</a>
                        </div>
                    </div>
                ...
                <div className="links_git">
                    <div className="gits">
                        <a href="https://github.com/dannyvsm" target="_blank" rel="noreferrer">Danny Smith</a>
                    </div>

                    <div className="gits">
                        <a href="https://github.com/Jwilss3" target="_blank" rel="noreferrer">Jess Wilson</a>
                    </div>
